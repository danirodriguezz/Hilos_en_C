...
En el código tenemos una parte de la función que nos divide la parte del vector a la que se va a encargar de realizar el cálculo cada hilo.
...
Si tenemos ejecutando el hilo 1 de 4 que tenemos, y tenemos un vector de tamaño 1000 el cálculo de start sera :
...
Entonces como vemos se divide el tamaño del vector en función del el hilo que se este ejecutando.
...
![Terminal](imagenes/Captura desde 2024-05-10 19-02-55.png){width=100%}
